...
export function ModerationRules({
  ...
  return (
    <section className="container-shell reveal-on-scroll pt-16 md:pt-20">
      <div className="rounded-[30px] border border-orange-100 bg-white p-6 shadow-[0_16px_50px_rgba(120,53,15,.06)] md:p-9">
        ...
        <div className={`mt-7 grid gap-5 ${rejected?.length ? "lg:grid-cols-2" : ""}`}>
          <div className="rounded-[24px] bg-emerald-50 p-5 transition duration-300 hover:-translate-y-0.5 hover:shadow-md md:p-6">
          ...
          {rejected?.length ? (
            <div className="rounded-[24px] bg-red-50 p-5 transition duration-300 hover:-translate-y-0.5 hover:shadow-md md:p-6">
